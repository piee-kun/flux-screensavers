...
This repo is set up to cross-compile Windows binaries from Linux using [Nix][nix].
...
Native Windows builds are currently untested.
You’ll need Rust and a static build of SDL2 linked at build time.
